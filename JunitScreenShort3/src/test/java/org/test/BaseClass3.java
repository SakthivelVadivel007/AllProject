...
public class BaseClass3 {
	...
	return findElement;
		...
		public Alert getText(String getText) {
	Alert alert = driver.switchTo().alert();
	...
	return alert;
		...
		public static WebElement sendKeys(WebElement element,String keys) {
			...
			public Actions sendKeys(WebElement data) {
				Actions ac = new Actions(driver);
			...
			public static  WebElement takeScreenShort( WebElement element, String filePath, String fileName) throws IOException {
