...
return alert;
	...
	public static Select getSelectByIndex(WebElement element, int index) {
		Select se = new Select(element);
		se.selectByIndex(index);
		return se;
	
	}
		public static Select getSelectByisibleText(WebElement element, String vicibleText) {
			Select se = new Select(element);
			se.selectByVisibleText(vicibleText);
			return se;
